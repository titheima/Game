...
jQuery.easing.jswing = jQuery.easing.swing, jQuery.extend(jQuery.easing, {
    ...
    if (!t.jQuery) {
        ...
        for (var a = {}, r = a.hasOwnProperty, o = a.toString,
                 s = "Boolean Number String Function Array Date RegExp Object Error".split(" "),
                 l = 0; l < s.length; l++)a["[object " + s[l] + "]"] = s[l].toLowerCase();
    ...
    return function (t, e, i, n) {
        ...
        function o(t, i, n, a) {
            ...
            var f = 4, p = .001, g = 1e-7, v = 10, m = 11, b = 1 / (m - 1), y = "Float32Array" in e;
            if (4 !== arguments.length)return !1;
            for (var x = 0; 4 > x; ++x)if ("number" != typeof arguments[x] || isNaN(arguments[x]) || !isFinite(arguments[x]))return !1;
            t = Math.min(t, 1), n = Math.min(n, 1), t = Math.max(t, 0), n = Math.max(n, 0);
            var w = y ? new Float32Array(m) : new Array(m), k = !1, S = function (e) {
        ...
        function l(t) {
            if (t) {
                ...
                for (var a = 0; i > a; a++)if (m.State.calls[a]) {
                    var o = m.State.calls[a], s = o[0], c = o[2], h = o[3], p = !!h, g = null;
                            ...
                            for (var M in c.visibility !== n && "hidden" !== c.visibility && y.setPropertyValue(S, "visibility", c.visibility), k)if ("element" !== M) {
                                ...
                                if (A.currentValue = P, "tween" === M) g = P; else {
                                    if (y.Hooks.registered[M]) {
                                        var D = y.Hooks.getRoot(M), _ = r(S).rootPropertyValueCache[D];
        ...
        function u(t, e) {
            ...
            for (var i = m.State.calls[t][0], a = m.State.calls[t][1], o = m.State.calls[t][2], s = m.State.calls[t][4],
                     l = !1, u = 0, c = i.length; c > u; u++) {
                var h = i[u].element;
            ...
            m.State.calls[t] = !1;
            for (var p = 0, g = m.State.calls.length; g > p; p++)if (!1 !== m.State.calls[p]) {
                l = !0;
                break
            }
                        ...
                        if ("scroll" === P) {
                            ...
                            u.container ? f.isWrapped(u.container) || f.isNode(u.container) ? (u.container = u.container[0] || u.container, M = (x = u.container["scroll" + T]) + d(o).position()[T.toLowerCase()] + I) : u.container = null : (x = m.State.scrollAnchor[m.State["scrollProperty" + T]], k = m.State.scrollAnchor[m.State["scrollProperty" + ("Left" === T ? "Top" : "Left")]], M = d(o).offset()[T.toLowerCase()] + I), c = {
                                scroll: {
                                    ...
                                    unitType: "",
                                    easing: u.easing,
                                    scrollData: {container: u.container, direction: T, alternateValue: k}
                                }, element: o
                            ...
                            for (var O in r(o).tweensContainer && !0 === r(o).isAnimating && (D = r(o).tweensContainer), d.each(b, function (t, e) {
                                if (RegExp("^" + y.Lists.colors.join("$|^") + "$").test(t)) {
                                    ...
                                    if (y.RegEx.isHex.test(a)) {
                                        for (var s = ["Red", "Green", "Blue"], l = y.Values.hexToRgb(a),
                                                 u = o ? y.Values.hexToRgb(o) : n, d = 0; d < s.length; d++) {
                                            var c = [l[d]];
                                ...
                                var V = h(b[O]), z = V[0], N = V[1], B = V[2];
                                O = y.Names.camelCase(O);
                                var W = y.Hooks.getRoot(O), E = !1;
                        ...
                        default:
                            if (!d.isPlainObject(b) || f.isEmptyObject(b)) {
                                if (f.isString(b) && m.Redirects[b]) {
                                    var I = (O = d.extend({}, w)).duration, D = O.delay || 0;
        ...
        1: [function (t, e, i) {
            ...
            n._set("bar", {
                ...
                t.controllers.bar = t.DatasetController.extend({
                    dataElementType: a.Rectangle, initialize: function () {
                        ...
                        var t, e, i = this.getIndexScale(), n = this.getStackCount(), a = this.index, r = [],
                            o = i.isHorizontal(), s = o ? i.left : i.top, l = s + (o ? i.width : i.height);
                        ...
                        var n, a, o, s, l, u = i.scale.options, d = this.getStackIndex(t), c = i.pixels, h = c[e],
                            f = c.length, p = i.start, g = i.end;
                ...
                t.controllers.doughnut = t.controllers.pie = t.DatasetController.extend({
                    ...
                    update: function (t) {
                        ...
                        if (f < 2 * Math.PI) {
                            var p = a.rotation % (2 * Math.PI),
                                ...
                                v = {x: Math.cos(p), y: Math.sin(p)}, m = {x: Math.cos(g), y: Math.sin(g)},
                    ...
                    updateElement: function (t, e, i) {
                        var n = this, a = n.chart, o = a.chartArea, s = a.options, l = s.animation,
                            ...
                            g = i && l.animateScale ? 0 : n.innerRadius, v = i && l.animateScale ? 0 : n.outerRadius,
                    ...
                    getMaxBorderWidth: function (t) {
                        for (var e, i, n = 0, a = this.index, r = t.length,
                                 o = 0; o < r; o++)e = t[o]._model ? t[o]._model.borderWidth : 0, n = (i = t[o]._chart ? t[o]._chart.config.data.datasets[a].hoverBorderWidth : 0) > (n = e > n ? e : n) ? i : n;
                        return n
                    }
                })
            }
            ...
            n._set("polarArea", {
                ...
                t.controllers.polarArea = t.DatasetController.extend({
                    ...
                    updateElement: function (t, e, i) {
                        for (var n = this, a = n.chart, o = n.getDataset(), s = a.options, l = s.animation, u = a.scale,
                                 d = a.data.labels, c = n.calculateCircumference(o.data[e]), h = u.xCenter,
                                 f = u.yCenter, p = 0, g = n.getMeta(),
                                 v = 0; v < e; ++v)isNaN(o.data[v]) || g.data[v].hidden || ++p;
                        var m = s.startAngle, b = t.hidden ? 0 : u.getDistanceFromCenterForValue(o.data[e]),
                            y = m + c * p, x = y + (t.hidden ? 0 : c),
                ...
                t.Animation = a.extend({
                    ...
                    advance: function (t) {
                        for (var e, i, n = this.animations,
                                 a = 0; a < n.length;)i = (e = n[a]).chart, e.currentStep = (e.currentStep || 0) + t, e.currentStep = Math.min(e.currentStep, e.numSteps), r.callback(e.render, [i, e], i), r.callback(e.onAnimationProgress, [e], i), e.currentStep >= e.numSteps ? (r.callback(e.onAnimationComplete, [e], i), i.animating = !1, n.splice(a, 1)) : ++a
                    }
            ...
            "use strict";
            var n = t(25), a = t(45), r = t(28), o = t(48);
            e.exports = function (t) {
                var e = t.plugins;
                ...
                t.types = {}, t.instances = {}, t.controllers = {}, a.extend(t.prototype, {
                    construct: function (e, i) {
                        ...
                        var s = o.acquireContext(e, i), l = s && s.canvas, u = l && l.height, d = l && l.width;
                        ...
                        var i = this, n = i.options, r = i.canvas, o = n.maintainAspectRatio && i.aspectRatio || null,
                        ...
                        n.scales && (o = o.concat((n.scales.xAxes || []).map(function (t) {
                            ...
                            var o = n.options, s = a.valueOrDefault(o.type, n.dtype),
                        ...
                        return a.each(e.data.datasets, function (a, r) {
                            ...
                            if (o.type && o.type !== s && (e.destroyDatasetMeta(r), o = e.getDatasetMeta(r)), o.type = s, i.push(o.type), o.controller) o.controller.updateIndex(r); else {
                        ...
                        var n = this.getDatasetMeta(t), a = {meta: n, index: t, easingValue: i};
            ...
            e.exports = function (t) {
                ...
                function o(t, n, a) {
                    var r = document.defaultView, o = t.parentNode, s = r.getComputedStyle(t)[n],
                        l = r.getComputedStyle(o)[n], u = i(s), d = i(l), c = Number.POSITIVE_INFINITY;
                ...
                t.layoutService = {
                    defaults: {}, addBox: function (t, e) {
                        ...
                        for (var n, a = ["fullWidth", "position", "weight"], r = a.length,
                                 o = 0; o < r; ++o)n = a[o], i.hasOwnProperty(n) && (e[n] = i[n])
                    }, update: function (t, a, r) {
                        if (t) {
                            var o = t.options.layout || {}, s = n.options.toPadding(o.padding), l = s.left, u = s.right,
                                d = s.top, c = s.bottom, h = e(t.boxes, "left"), f = e(t.boxes, "right"),
                                p = e(t.boxes, "top"), g = e(t.boxes, "bottom"), v = e(t.boxes, "chartArea");
                            i(h, !0), i(f, !1), i(p, !0), i(g, !1);
                            var m = a - l - u, b = r - d - c, y = b / 2, x = (a - m / 2) / (h.length + f.length),
                                w = (r - y) / (p.length + g.length), k = m, S = b, C = [];
            ...
            n._set("global", {plugins: {}}), e.exports = function (t) {
                t.plugins = {
                    _plugins: [], _cacheId: 0, register: function (t) {
                        ...
                        var i = [], a = [], o = t && t.config || {}, s = o.options && o.options.plugins || {};
            ...
            n._set("scale", {
                ...
                t.Scale = a.extend({
                    ...
                    calculateTickRotation: function () {
                        ...
                        if (a.length && t.options.display && t.isHorizontal())for (var u,
                    ...
                    fit: function () {
                        var t = this, n = t.minSize = {width: 0, height: 0}, a = s(t._ticks), l = t.options,
                            ...
                            p = i(u), g = l.gridLines.tickMarkLength;
                        ...
                        if (u.display && h) {
                            var m = r.longestText(t.ctx, p.font, a, t.longestTextCache), b = r.numberOfLabelLines(a),
                            ...
                            if (f) {
                                ...
                                var C = e(t.ctx, a[0], p.font), M = e(t.ctx, a[a.length - 1], p.font);
                    ...
                    draw: function (t) {
                        ...
                        if (a.display) {
                            var s = e.ctx, u = n.global, d = a.ticks.minor, c = a.ticks.major || d, h = a.gridLines,
                                f = a.scaleLabel, p = 0 !== e.labelRotation, g = e.isHorizontal(),
                                v = d.autoSkip ? e._autoSkip(e.getTicks()) : e.getTicks(),
                                m = r.valueOrDefault(d.fontColor, u.defaultFontColor), b = i(d),
                                y = r.valueOrDefault(c.fontColor, u.defaultFontColor), x = i(c),
                                w = h.drawTicks ? h.tickMarkLength : 0,
                                k = r.valueOrDefault(f.fontColor, u.defaultFontColor), S = i(f),
                            ...
                            if (r.each(v, function (i, n) {
                                    if (!r.isNullOrUndef(i.label)) {
                                        ...
                                        var R = "middle", V = "middle", z = d.padding;
                                        if (g) {
                                            var N = w + z;
                                    ...
                                    if (h.display && (s.save(), s.lineWidth = t.glWidth, s.strokeStyle = t.glColor, s.setLineDash && (s.setLineDash(t.glBorderDash), s.lineDashOffset = t.glBorderDashOffset), s.beginPath(), h.drawTicks && (s.moveTo(t.tx1, t.ty1), s.lineTo(t.tx2, t.ty2)), h.drawOnChartArea && (s.moveTo(t.x1, t.y1), s.lineTo(t.x2, t.y2)), s.stroke(), s.restore()), d.display) {
                                        ...
                                        var e = t.label;
                                        if (r.isArray(e))for (var i = 0,
                                                                  n = 0; i < e.length; ++i)s.fillText("" + e[i], 0, n), n += 1.5 * b.size; else s.fillText(e, 0, 0);
                                        s.restore()
                                    }
                                }), f.display) {
                                var _, F, O = 0, L = o(f) / 2;
                                if (g) _ = e.left + (e.right - e.left) / 2, F = "bottom" === a.position ? e.bottom - L - C.bottom : e.top + L + C.top; else {
                            ...
                            if (h.drawBorder) {
                                ...
                                var V = e.left, z = e.right, N = e.top, B = e.bottom, W = r.aliasPixel(s.lineWidth);
            ...
            n._set("global", {
                ...
                t.Tooltip = a.extend({
                    initialize: function () {
                        ...
                        var i, n, a, s, l, u, d, c = this, h = c._options, f = c._model, p = c._model = o(h),
                            g = c._active, v = c._data, m = {xAlign: f.xAlign, yAlign: f.yAlign}, b = {x: f.x, y: f.y},
                        ...
                        if (g.length) {
                            ...
                            h.filter && (S = S.filter(function (t) {
                                ...
                                var n = t.x, a = t.y, r = t.caretSize, o = t.caretPadding, s = t.cornerRadius,
                                    l = i.xAlign, u = i.yAlign, d = r + o, c = s + o;
                        ...
                        if ("center" === h) s = p + v / 2, "left" === c ? (a = (n = f) - u, r = n, o = s + u, l = s - u) : (a = (n = f + g) + u, r = n, o = s - u, l = s + u); else if ("left" === c ? (n = (a = f + d + u) - u, r = a + u) : "right" === c ? (n = (a = f + g - d - u) - u, r = a + u) : (n = (a = f + g / 2) - u, r = a + u), "top" === h) s = (o = p) - u, l = o; else {
                            s = (o = p + v) + u, l = o;
                            var m = r;
                            r = n, n = m
                        }
                        ...
                        var o = i.xAlign, s = i.yAlign, l = t.x, u = t.y, d = a.width, c = a.height, h = i.cornerRadius;
            ...
            n._set("global", {
                ...
                inLabelRange: function (t) {
                    ...
                    var i = this._view;
                    if (i) {
                        for (var n = r.getAngleFromPoint(i, {x: t, y: e}), a = n.angle, o = n.distance,
            ...
            n._set("global", {
                ...
                draw: function () {
                    ...
                    var v = [[t, n], [t, i], [e, i], [e, n]], m = ["bottom", "left", "top", "right"].indexOf(o, 0);
                        ...
                        if (!(isNaN(i) || i <= 0)) {
                            switch (e) {
                                ...
                                case"rect":
                                    ...
                                    break;
                                case"rectRounded":
                                    var c = i / Math.SQRT2, h = n - c, f = a - c, p = Math.SQRT2 * i;
            ...
            n._set("global", {plugins: {filler: {propagate: !0}}}), e.exports = function () {
                ...
                return {
                    id: "filler", afterDatasetsUpdate: function (t, n) {
                        var r, l, u, d, c = (t.data.datasets || []).length, h = n.propagate, f = [];
                        ...
                        var i = e.meta.$filler;
                        if (i) {
                            var a = t.ctx, o = i.el, s = o._view, d = o._children || [], c = i.mapper,
                                h = s.backgroundColor || n.global.defaultColor;
                            c && h && d.length && (r.canvas.clipArea(a, t.chartArea), function (t, e, i, n, a, r) {
                                var o, s, d, c, h, f, p, g = e.length, v = n.spanGaps, m = [], b = [], y = 0, x = 0;
            ...
            n._set("global", {
                ...
                var e = t.layoutService, i = r.noop;
                ...
                return t.Legend = a.extend({
                    initialize: function (t) {
                        ...
                        var t = this, e = t.options, i = e.labels, a = e.display, s = t.ctx, l = n.global,
                            u = r.valueOrDefault, d = u(i.fontSize, l.defaultFontSize),
                            c = u(i.fontStyle, l.defaultFontStyle), h = u(i.fontFamily, l.defaultFontFamily),
                            f = r.fontString(d, c, h), p = t.legendHitBoxes = [], g = t.minSize, v = t.isHorizontal();
                        if (v ? (g.width = t.maxWidth, g.height = a ? 10 : 0) : (g.width = a ? 10 : 0, g.height = t.maxHeight), a)if (s.font = f, v) {
                            var m = t.lineWidths = [0], b = t.legendItems.length ? d + i.padding : 0;
                        ...
                        var t = this, e = t.options, i = e.labels, a = n.global, s = a.elements.line, l = t.width,
                            u = t.lineWidths;
                        if (e.display) {
                            var d, c = t.ctx, h = r.valueOrDefault, f = h(i.fontColor, a.defaultFontColor),
                                ...
                                v = h(i.fontFamily, a.defaultFontFamily), m = r.fontString(p, g, v);
                            c.textAlign = "left", c.textBaseline = "middle", c.lineWidth = .5, c.strokeStyle = f, c.fillStyle = f, c.font = m;
                            var b = o(i, p), y = t.legendHitBoxes, x = t.isHorizontal();
                            d = x ? {x: t.left + (l - u[0]) / 2, y: t.top + i.padding, line: 0} : {
                                x: t.left + i.padding,
                                y: t.top + i.padding,
                                line: 0
                            };
                            ...
                            r.each(t.legendItems, function (n, o) {
                                var f = c.measureText(n.text).width, g = b + p / 2 + f, v = d.x, m = d.y;
                                x ? v + g >= l && (m = d.y += w, d.line++, v = d.x = t.left + (l - u[d.line]) / 2) : m + w > t.bottom && (v = d.x = v + t.columnWidths[d.line] + i.padding, m = d.y = t.top + i.padding, d.line++), function (t, i, n) {
                                    if (!(isNaN(b) || b <= 0)) {
                                ...
                                }(v, m, n), y[o].left = v, y[o].top = m, function (t, e, i, n) {
                    ...
                    id: "legend", beforeInit: function (t) {
                        ...
                        var i = t.options.legend, a = t.legend;
            ...
            n._set("global", {
                ...
                return t.Title = a.extend({
                    ...
                    draw: function () {
                        ...
                        if (a.display) {
                            var s, l, u, d = i(a.fontSize, o.defaultFontSize), c = i(a.fontStyle, o.defaultFontStyle),
                                ...
                                p = r.options.toLineHeight(a.lineHeight, d), g = p / 2 + a.padding, v = 0, m = t.top,
                            ...
                            var w = a.text;
                            if (r.isArray(w))for (var k = 0,
                                                      S = 0; S < w.length; ++S)e.fillText(w[S], 0, k, s), k += p; else e.fillText(w, 0, 0, s);
                            e.restore()
                        }
                    }
                }), {
                    id: "title", beforeInit: function (t) {
                        ...
                        var a = i.options.title, s = i.titleBlock;
            ...
            e.exports = function (t) {
                ...
                t.LinearScaleBase = t.Scale.extend({
                    getRightValue: function (e) {
                        ...
                        var t = this, e = t.options.ticks, i = t.getTickLimit(), r = {
            ...
            e.exports = function (t) {
                var e = {position: "left", ticks: {callback: a.formatters.logarithmic}}, i = t.Scale.extend({
                    determineDataLimits: function () {
                        var t = this, e = t.options, i = e.ticks, a = t.chart, r = a.data.datasets,
                            o = n.valueOrDefault, s = t.isHorizontal();
                        ...
                        var e, i, a, r = this, o = r.start, s = +r.getRightValue(t), l = r.options.ticks;
                        ...
                        var e, i, a = this, r = n.log10(a.end) - n.log10(a.start);
            ...
            e.exports = function (t) {
                ...
                function d(t, e, i, n) {
                    if (a.isArray(e))for (var r = i.y, o = 1.5 * n,
                                              s = 0; s < e.length; ++s)t.fillText(e[s], i.x, r), r += o; else t.fillText(e, i.x, i.y)
                }
                    ...
                    setDimensions: function () {
                        ...
                        this.options.pointLabels.display ? function (t) {
                            ...
                            for (e = 0; e < g; e++) {
                                ...
                                var v = t.getIndexAngle(e), m = a.toDegrees(v) % 360, b = l(m, n.x, i.w, 0, 180),
                        ...
                        if (i.display) {
                            var h = t.ctx, f = this.getIndexAngle(0), p = l(r.fontSize, e.defaultFontSize),
                                g = l(r.fontStyle, e.defaultFontStyle), v = l(r.fontFamily, e.defaultFontFamily),
                            ...
                            a.each(t.ticks, function (i, s) {
                                ...
                                var i = t.ctx, n = a.valueOrDefault, r = t.options, l = r.angleLines, h = r.pointLabels;
                                i.lineWidth = l.lineWidth, i.strokeStyle = l.color;
                                var f = t.getDistanceFromCenterForValue(r.ticks.reverse ? t.min : t.max), p = s(t);
                                i.textBaseline = "top";
                                for (var g = o(t) - 1; g >= 0; g--) {
                                    ...
                                    if (h.display) {
                                        var m = t.getPointPosition(g, f + 5), b = n(h.fontColor, e.defaultFontColor);
                                        i.font = p.font, i.fillStyle = b;
                                        var y = t.getIndexAngle(g), x = a.toDegrees(y);
            ...
            function v(t, e, i, a) {
                var o, d = a.time, c = d.unit || function (t, e, i, n) {
                            ...
                            return u[d - 1]
                        }(d.minUnit, t, e, i), h = g(c), f = r.valueOrDefault(d.stepSize, d.unitStepSize),
                    p = "week" === c && d.isoWeekday, v = a.ticks.major.enabled, m = l[c], b = n(t), y = n(e), x = [];
            ...
            e.exports = function (t) {
                var e = t.Scale.extend({
                    initialize: function () {
                        ...
                        var t, e, i, a, l, u, h = this, f = h.chart, g = h.options.time, v = s, m = o, b = [], y = [],
                            x = [];
                        for (t = 0, i = f.data.labels.length; t < i; ++t)x.push(p(f.data.labels[t], h));
                        for (t = 0, i = (f.data.datasets || []).length; t < i; ++t)if (f.isDatasetVisible(t))if (l = f.data.datasets[t].data, r.isObject(l[0]))for (y[t] = [], e = 0, a = l.length; e < a; ++e)u = p(l[e], h), b.push(u), y[t][e] = u; else b.push.apply(b, x), y[t] = x.slice(0); else y[t] = [];
                        ...
                        var t, e, i, a = this, r = a.min, o = a.max, s = a.options, d = s.time, c = [], f = [];
                        ...
                        var a = this.options, o = t.valueOf(), s = a.time.displayFormats, l = s[this._unit],
                            ...
                            g = f ? h : a.ticks.minor, v = r.valueOrDefault(g.callback, g.userCallback);
                        return v ? v(p, e, i) : p
...
$(window).scroll(function () {
    ...
    return t.init = function (t) {
        ...
        for (var o = 0,
                 s = t.length; o < s; o++)a = (n = t[o]).tagName.toLowerCase(), -1 !== ["input", "img"].indexOf(a) && (u[a](n), n = n.parentElement), -1 === n.className.indexOf("waves-effect") && (n.className += " waves-effect" + e)
    ...
    t(document).ready(function () {
        ...
        if (t(e).each(function (e, n) {
                var a = t(n), r = a.siblings("label, i");
                ...
                var i = t(e.target), a = !i.val(), r = !e.target.validity.badInput,
